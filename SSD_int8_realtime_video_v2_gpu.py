...
# Example usage:
# python SSD_int8_realtime_video_v2_gpu.py --model C:\path\to\ssd_int8_v2.onnx --device cpu --show-fps --batch-size 4
# python SSD_int8_realtime_video_v2_gpu.py --model C:\path\to\ssd_int8_v2.onnx --device cuda --show-fps --save-video --record-fps 15 --batch-size 2
...
def main():
    ...
    ap.add_argument(
        ...
        default="cpu",
        type=str,
        help="Compute device for ONNX Runtime inference and PyTorch postprocessing: cpu, cuda, or cuda:N.",
    )
    ap.add_argument(
        "--camera-device",
        default=None,
